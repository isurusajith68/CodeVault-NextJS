              ...
              <div className="max-w-sm  bg-white border border-gray-200 rounded-lg shadow ">
                ...
                <div className="p-5">
                  <div className="flex justify-around">
                    <span class="bg-gray-100 text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded border border-gray-700">
                  ...
                  <button id="toggle-btn" class="mt-2 text-blue-500 focus:outline-none">Read More</button>
                </div>
              </div>
            )
          })
